...
extension UIColor {
    ...
    class var defaultTintColor: UIColor { #colorLiteral(red: 0.1197796538, green: 0.648701489, blue: 0.6649698615, alpha: 1) }
    class var defaultPrimaryTextColor: UIColor { #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1) }
    ...
    class var defaultBackgroundColor: UIColor { #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.700042517) }

    class var defaultRouteCasing: UIColor { .defaultTintColor }
    class var defaultRouteLayer: UIColor { #colorLiteral(red: 0.1197796538, green: 0.648701489, blue: 0.6649698615, alpha: 1) }
